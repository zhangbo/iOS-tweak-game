...
@class AdCompAdapter, AdCompContent, AdCompView, NSMutableArray, NSString, NSTimer, UIActivityIndicatorView, UIButton, UIImageView, UIView, UIViewController;

@interface AdCompDataImpl : NSObject <SKStoreProductViewControllerDelegate, AdCompMraidViewDelegate, AdCompConnectionDelegate, UIWebViewDelegate, AdCompWebViewControllerDelegate, MFMessageComposeViewControllerDelegate>
{
...
@property(nonatomic) _Bool firstBecomeActive; // @synthesize firstBecomeActive;
